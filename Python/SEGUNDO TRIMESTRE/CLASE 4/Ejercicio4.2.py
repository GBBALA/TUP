...
# Escriba un progama que tenga 2 listas y que a continuación
...
union = list(conjunto1 | conjunto2) # Unión de los dos conjuntos
...
print(f'Lista de palabras que aparecen en ambos listas: {interseccion}')
