...
show(*person)               # Esto es lo mismo que anterior pero pasamos todo junto
...
def listarTerminos(nombre, *nombres, **terminos):  # Lo más utilizado es **kwargs para recibir los argumentos
...
resultado = factorial(5)  # Lo hacemos en Hardcode
